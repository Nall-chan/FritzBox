    ...
    public function GetConfigurationForm()
    {
        ...
        foreach ($Devices as $UUID => $Data) {
            foreach ($Data as $Device) {
                ...
                $InstanceIDConfigurator = array_search($Device['HOST'], $DevicesAddress);
                ...
                $AddDevice['create']['https://' . $Device['HOST']] = [
                    [
                ...
                $AddDevice['create']['http://' . $Device['HOST']] = [
                    [
                        'moduleID'      => '{32CF40DC-51DA-6C63-8BD7-55E82F64B9E7}',
                        'configuration' => new stdClass()
                    ],
    ...
    protected function Discover(): array
    {
        ...
        if ($socket) {
            ...
            do {
                ...
                $Host = parse_url($Data['LOCATION'], PHP_URL_HOST);
                $Host = gethostbyaddr(substr($Host, 1, -1));
                $DevicesData[explode(':', $Data['USN'])[1]][$Host] = ['SERVER' => $Data['SERVER'], 'HOST' => $Host];
